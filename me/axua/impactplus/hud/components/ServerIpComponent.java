...
public class ServerIpComponent extends Panel {
  ServerIp mod;
  ...
  public ServerIpComponent(double ix, double iy, ClickGUI parent) {
    super("ServerIp", ix, iy, 10.0D, 10.0D, false, parent);
    this.mod = (ServerIp)ModuleManager.getModuleByName("ServerIp");
  ...
  public void drawHud() {
    ...
    if (mc.getCurrentServerData() != null && 
      !(mc.getCurrentServerData()).serverIP.equals(""))
      this.serve = "Ip " + numbercf + (mc.getCurrentServerData()).serverIP; 
    if (mc.isIntegratedServerRunning())
      this.serve = "Ip " + numbercf + "Singleplayer"; 
    if (mc.getCurrentServerData() == null)
      this.serve = "Ip " + numbercf + "ERROR"; 
