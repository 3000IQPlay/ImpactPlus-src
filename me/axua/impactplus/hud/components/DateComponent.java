...
public class DateComponent extends Panel {
  TheDate mod;
  ...
  public DateComponent(double ix, double iy, ClickGUI parent) {
    super("Date", ix, iy, 10.0D, 10.0D, false, parent);
    this.mod = (TheDate)ModuleManager.getModuleByName("TheDate");
