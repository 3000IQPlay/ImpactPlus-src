...
public class CrystalsComponent extends Panel {
  ...
  public void drawHud() {
    ...
    if (this.mod.mode.getValString().equalsIgnoreCase("Item")) {
      ...
      float hi = ImpactPlus.CustomFont2.getStringWidth(this.cry);
      float hi2 = mc.fontRenderer.getStringWidth(this.cry);
      if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.CustomFont2.drawStringWithShadow(this.cry, (float)this.x - hi, (float)this.y, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(this.cry, (float)this.x - hi2, (float)this.y, this.text.getRGB());
        } 
      } else if (this.font) {
        ImpactPlus.CustomFont2.drawStringWithShadow(this.cry, (float)this.x, (float)this.y, this.text.getRGB());
      } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    doStuff();
    double w = (ImpactPlus.CustomFont2.getStringWidth(this.cry) + 2.0F);
    ...
    if (this.extended) {
      ...
      if (this.mod.mode.getValString().equalsIgnoreCase("Item")) {
        ...
        if (this.mod.right.getValBoolean()) {
          if (this.font) {
            ImpactPlus.CustomFont2.drawStringWithShadow(this.cry, (float)this.x - hi, (float)this.y + 10.0F, this.text.getRGB());
          } else {
            mc.fontRenderer.drawStringWithShadow(this.cry, (float)this.x - hi2, (float)this.y + 10.0F, this.text.getRGB());
          } 
        } else if (this.font) {
          ImpactPlus.CustomFont2.drawStringWithShadow(this.cry, (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
        } else {
