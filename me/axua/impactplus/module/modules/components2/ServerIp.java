...
public class ServerIp extends Module {
  ...
  public ServerIp() {
    super("ServerIp", Module.Category.COMPONENTS2);
    setDrawn(false);
  }
  ...
  public void setup() {
    ...
    this.red = new Setting("Red", this, 80.0D, 0.0D, 255.0D, true, "ServerIpRed");
    this.green = new Setting("Green", this, 80.0D, 0.0D, 255.0D, true, "ServerIpGreen");
    this.blue = new Setting("Blue", this, 255.0D, 0.0D, 255.0D, true, "ServerIpBlue");
    ...
    (ImpactPlus.getInstance()).settingsManager.rSetting(this.rainbow = new Setting("Rainbow", this, true, "ServerIpRainbow"));
    (ImpactPlus.getInstance()).settingsManager.rSetting(this.customFont = new Setting("Custom Font", this, true, "ServerIpCustomFont"));
    (ImpactPlus.getInstance()).settingsManager.rSetting(this.right = new Setting("AlignRight", this, false, "ServerIpRight"));
    (ImpactPlus.getInstance()).settingsManager.rSetting(this.numbercolour = new Setting("Number Colour", this, "White", numbercolours, "ServerIpNumberColour"));
  }
