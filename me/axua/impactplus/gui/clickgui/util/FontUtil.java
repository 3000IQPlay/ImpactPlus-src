...
public class FontUtil {
  ...
  public static void drawCenteredStringWithShadow(String text, double x, double y, int color) {
    drawStringWithShadow(text, x - (fontRenderer.getStringWidth(text) / 2.0F), y, color);
  }
  
  public static void drawTotalCenteredString(String text, double x, double y, int color) {
    drawString(text, x - (fontRenderer.getStringWidth(text) / 2.0F), y - (fontRenderer.FONT_HEIGHT / 2.0F), color);
  }
  
  public static void drawTotalCenteredStringWithShadow(String text, double x, double y, int color) {
    drawStringWithShadow(text, x - (fontRenderer.getStringWidth(text) / 2.0F), y - (fontRenderer.FONT_HEIGHT / 2.0F), color);
  }
}
