...
public final class GLUProjection {
  ...
  public static class Line {
    ...
    public GLUProjection.Vector3D intersect(Line line) {
      ...
      this.sourcePoint.x += this.direction.x * t;
      this.sourcePoint.y += this.direction.y * t;
      this.sourcePoint.z += this.direction.z * t;
      return result;
    }
  ...
  public Vector3D getRotationVector(double rotYaw, double rotPitch) {
    double c = Math.cos(-rotYaw * 0.01745329238474369D - Math.PI);
    double s = Math.sin(-rotYaw * 0.01745329238474369D - Math.PI);
